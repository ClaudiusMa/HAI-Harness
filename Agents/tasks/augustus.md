...
- Status: unassigned
- Task / outcome: -
- Read first: `../onboarding.md` → `../project_context.md` → `../augustus.md` → this file → current handoff/design contract
- Active now: -
- Next in sequence: -
...
- Read-only / preserve: -
- Current handoff: -
- Dependencies: exact prerequisite, ordering, or independent of Julius
- Verification: -
...
- Implement in this order:
  - None yet. Fill this section when assigning work.

## Stop Conditions

- Stop before writing outside the assigned scope.
